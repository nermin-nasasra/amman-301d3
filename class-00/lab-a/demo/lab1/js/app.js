...
//   console.log(rando);
  ...
  // becouse when we use let we mean this variable decleared and used just on this scope of code (i mean while scope) and can not call it out of this scope (while scope) on console.log statment
